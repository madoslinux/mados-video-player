...
TRANSLATIONS = {
    ...
    "Português": {
        ...
        "next_track": "Próximo",
        "prev_track": "Anterior",
        "forward_10": "Avançar 10s",
        "backward_10": "Voltar 10s",
        "forward_60": "Avançar 60s",
        "backward_60": "Voltar 60s",
        ...
        "subtitle_track": "Faixa de Legenda",
        ...
        "screenshot_saved": "Captura salva em",
        "screenshot_error": "Erro ao salvar captura",
        "always_on_top": "Sempre no Topo",
        "preferences": "Preferências",
        "about": "Sobre",
        "about_title": "Sobre madOS Video Player",
        "about_text": "Reprodutor de vídeo leve para madOS\\n\\nAtalhos de teclado:\\nEspaço - Play/Pause\\nF - Tela Cheia\\nM - Mudo\\nSetas - Navegar\\nCtrl+T - Sempre no Topo",
        "error": "Erro",
        "warning": "Aviso",
        "info": "Informação",
        ...
        "seeking": "Buscando...",
        "ready": "Pronto",
        "no_video": "Nenhum vídeo carregado",
        "drop_video": "Arraste um arquivo de vídeo aqui",
        "recent_files": "Arquivos Recentes",
        "clear_history": "Limpar Histórico",
        "no_recent_files": "Nenhum arquivo recente",
        "load_playlist": "Carregar Lista...",
        "manage_playlists": "Gerenciar Listas...",
        "delete_playlist": "Excluir",
        "rename_playlist": "Renomear",
        "playlist_name": "Nome da Lista",
        "playlist_saved": "Lista salva",
        "playlist_loaded": "Lista carregada",
        "playlist_deleted": "Lista excluída",
        "no_saved_playlists": "Nenhuma lista salva",
        "confirm_delete": "Excluir esta lista?",
        "new_name": "Novo Nome",
        "save": "Salvar",
        "load": "Carregar",
        "cancel": "Cancelar",
    ...
    "Italiano": {
        ...
        "prev_track": "Precedente",
        "forward_10": "Avanti 10s",
        "backward_10": "Indietro 10s",
        "forward_60": "Avanti 60s",
        "backward_60": "Indietro 60s",
        "speed_up": "Velocità +",
        "speed_down": "Velocità -",
        "normal_speed": "Velocità Normale",
        "fullscreen": "Schermo Intero",
        "exit_fullscreen": "Esci da Schermo Intero",
        "playlist": "Playlist",
        "show_playlist": "Mostra Playlist",
        "hide_playlist": "Nascondi Playlist",
        "shuffle": "Casuale",
        "repeat": "Ripeti",
        "repeat_off": "Ripeti: Off",
        "repeat_all": "Ripeti: Tutti",
        "repeat_one": "Ripeti: Uno",
        "volume": "Volume",
        "mute": "Muto",
        "unmute": "Attiva Audio",
        "volume_up": "Volume +",
        ...
        "subtitle_track": "Traccia Sottotitoli",
        "subtitle_off": "Off",
        ...
        "screenshot_saved": "Screenshot salvato in",
        "screenshot_error": "Errore nel salvare screenshot",
        "always_on_top": "Sempre in Primo Piano",
        "preferences": "Preferenze",
        "about": "Informazioni",
        "about_title": "Informazioni su madOS Video Player",
        "about_text": "Lettore video leggero per madOS\\n\\nScorciatoie da tastiera:\\nSpazio - Play/Pausa\\nF - Schermo Intero\\nM - Muto\\nFrecce - Naviga\\nCtrl+T - Sempre in Primo Piano",
        "error": "Errore",
        "warning": "Avviso",
        "info": "Informazione",
        "file_not_found": "File non trovato",
        "unsupported_format": "Formato non supportato",
        "failed_to_load": "Impossibile caricare il file",
        "loading": "Caricamento...",
        "buffering": "Buffering...",
        "seeking": "Ricerca...",
        "ready": "Pronto",
        "no_video": "Nessun video caricato",
        "drop_video": "Trascina un file video qui",
        ...
        "manage_playlists": "Gestisci Playlist...",
        "delete_playlist": "Elimina",
        "rename_playlist": "Rinomina",
        "playlist_name": "Nome Playlist",
        "playlist_saved": "Playlist salvata",
        "playlist_loaded": "Playlist caricata",
        "playlist_deleted": "Playlist eliminata",
        "no_saved_playlists": "Nessuna playlist salvata",
    ...
    "한국어": {
        ...
        "playlist": "재생 목록",
        "show_playlist": "재생 목록 표시",
        "hide_playlist": "재생 목록 숨기기",
        "shuffle": "무작위",
        "repeat": "반복",
        "repeat_off": "반복: 꺼짐",
        "repeat_all": "반복: 모두",
        ...
        "screenshot_error": "스크린샷 저장 오류",
        "always_on_top": "항상 위",
        "preferences": "환경 설정",
        "about": "정보",
        "about_title": "madOS 비디오 플레이어 정보",
        "about_text": "madOS용 경량 비디오 플레이어\\n\\n키보드 단축키:\\n스페이스 - 재생/일시정지\\nF - 전체 화면\\nM - 음소거\\n방향키 - 탐색\\nCtrl+T - 항상 위",
        "error": "오류",
        "warning": "경고",
        "info": "정보",
        "file_not_found": "파일을 찾을 수 없음",
        "unsupported_format": "지원하지 않는 형식",
        "failed_to_load": "파일 로드 실패",
        "loading": "로딩 중...",
        "buffering": "버퍼링 중...",
        "seeking": "탐색 중...",
        "ready": "준비됨",
        "no_video": "로드된 비디오 없음",
        "drop_video": "비디오 파일을 여기에 드롭",
        "recent_files": "최근 파일",
        "clear_history": "기록 지우기",
        "no_recent_files": "최근 파일 없음",
        "load_playlist": "재생 목록 로드...",
        "manage_playlists": "재생 목록 관리...",
        "delete_playlist": "삭제",
        "rename_playlist": "이름 변경",
        "playlist_name": "재생 목록 이름",
        "playlist_saved": "재생 목록 저장됨",
        "playlist_loaded": "재생 목록 로드됨",
        "playlist_deleted": "재생 목록 삭제됨",
        "no_saved_playlists": "저장된 재생 목록 없음",
        "confirm_delete": "이 재생 목록을 삭제하시겠습니까?",
        "new_name": "새 이름",
        "save": "저장",
        "load": "로드",
        "cancel": "취소",
